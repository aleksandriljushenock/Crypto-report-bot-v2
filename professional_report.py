...
def build_professional_report():
    sections=[]
    for fn in [lambda: build_top_ai_report(refresh=False),build_capital_flow_report,build_sentiment_report,build_narrative_report,build_smart_money_report,build_news_report,build_learning_report,portfolio_report]:
