...
SPECS: tuple[SettingSpec, ...] = (
    ...
    SettingSpec("PROFITABILITY_REQUIRE_EXECUTION_CHAMPION", "bool", True, "filters", "Execution Champion обязателен", "Не выпускать Paper/Trade сигнал без валидированного Execution ML champion."),
    SettingSpec("PROFITABILITY_MIN_EXECUTIONS", "int", 120, "filters", "Мин. execution-сделок", "Минимум подтвержденных исполнений до допуска profit-first сигналов.", 20, 10000),
    SettingSpec("PROFITABILITY_MIN_PF", "float", 1.15, "filters", "Мин. execution PF", "Минимальный robust Profit Factor на execution-only истории.", 0, 10),
    SettingSpec("PROFITABILITY_MIN_PAPER_EXECUTIONS", "int", 80, "filters", "Мин. Paper execution", "Минимум фактически исполненных Paper-сделок перед допуском profit-ready режима.", 20, 10000),
    SettingSpec("PROFITABILITY_MIN_PAPER_PF", "float", 1.05, "filters", "Мин. Paper PF", "Минимальный robust Profit Factor на фактических Paper execution.", 0, 10),
    SettingSpec("DIRECTION_MIN_EXECUTION_SAMPLES", "int", 60, "filters", "Мин. сделок направления", "Минимум execution-примеров LONG/SHORT для допуска направления.", 10, 5000),
    SettingSpec("BREAKOUT_MIN_EXECUTION_SAMPLES", "int", 60, "filters", "Мин. Breakout execution", "Breakout остается Shadow до накопления достаточной execution-истории.", 10, 5000),
    ...
    SettingSpec("POSITION_SIZING_ENABLED", "bool", False, "position", "Динамическая ставка", "Включить рекомендованный размер позиции."),
    ...
    SettingSpec("PAPER_MAX_LEVERAGE", "int", 3, "paper", "Макс. плечо", "Верхний предел автоматического плеча.", 1, 125),
    ...
    SettingSpec("AI_OPTIMIZER_MIN_TRADES", "int", 200, "optimizer", "Мин. сделок Optimizer", "Минимум закрытых Paper-сделок для рекомендаций по фильтрам.", 10, 1000),
    ...
    SettingSpec("ADAPTIVE_MODEL_MIN_TRADES", "int", 200, "optimizer", "Мин. сделок модели", "Минимальная выборка для обучения новой adaptive-модели.", 20, 5000),
    SettingSpec("ADAPTIVE_MODEL_MIN_VALIDATION", "int", 60, "optimizer", "Мин. validation", "Минимум сделок в хронологической проверочной выборке.", 8, 1000),
    SettingSpec("ADAPTIVE_MODEL_BLEND_WEIGHT", "float", 0.05, "optimizer", "Вес Adaptive Model", "Желаемая доля adaptive probability; V57 дополнительно ограничивает runtime-cap.", 0.0, 0.45),
    SettingSpec("ADAPTIVE_MODEL_MAX_RUNTIME_WEIGHT", "float", 0.05, "optimizer", "Runtime cap Adaptive", "Жесткий верхний предел влияния Adaptive до доказанного execution edge.", 0.0, 0.10),
)
