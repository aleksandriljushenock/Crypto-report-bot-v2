...
def test_v46_version():
    assert Path('VERSION').read_text().strip() in {'47.0.0','48.0.0','49.0.0','50.0.0','51.0.0','52.0.0','53.0.0','54.0.0','55.0.0','56.0.0','57.0.0','57.1.0','57.2.0','58.0.0','58.1.0','58.2.0','58.3.0','58.4.0','58.5.0'}
